def solution(s): # s type:string
    ...
    num_box = {"zero":"0", "one":"1", "two":"2", "three":"3", "four":"4", "five":"5", "six":"6", "seven":"7", "eight":"8", "nine":"9"} # type:dict
    ...
    answer = int(answer_string) # change answer_string(type:string) to answer(type:int)
    return answer
